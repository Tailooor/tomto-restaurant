    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Tomto Restaurant</h3>
            <p className="text-gray-400 mb-4">
              Authentic Italian cuisine made with love and tradition. Join us for an unforgettable dining experience.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="#hours" className="text-gray-400 hover:text-white transition-colors">
                  Hours
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>&copy; {currentYear} Tomto Restaurant. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
